...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'payform'); ?>
		<?php echo $form->textField($model,'payform'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'category_standart'); ?>
		<?php echo $form->textField($model,'category_standart',array('size'=>60,'maxlength'=>128)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'sleeper'); ?>
		<?php echo $form->textField($model,'sleeper'); ?>
	</div>
