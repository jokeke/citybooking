...
class ToursController extends ControllerModule
{
	/**
	...
	{
		$model=$this->loadModel($id);
        $timetable = TourTimetable::model()->findAllByAttributes(array('tour_id'=>$id));
        $prices = TourPrices::model()->findByAttributes(array('tour_id'=>$id));
