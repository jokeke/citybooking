...
class ConferenceController extends ControllerModule
{
	/**
	...
	public function actionUpdate($id)
	{
        ...
        $prices = ConferencePrices::model()->findAllByAttributes(array('conference_id'=>$id));
        $types = ConferenceTypes::model()->findAllByAttributes(array('conference_id'=>$id));
